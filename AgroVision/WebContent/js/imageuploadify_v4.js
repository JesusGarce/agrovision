    ...
    this.each(function() {
      ...
      <div class="imageuploadify well">
        ...
        <div id="drag" class="imageuploadify-images-list text-center" >
          ...
          <span class='imageuploadify-message'>Arrastra tu imagen aquí...</span>
      ...
      //let loading_text = dragbox.find(".imageuploadify-loading h3");
      
  		//document.getElementById("plaga").innerHTML = dragbox;
      ...
      const readingFile = (id, file) => {
         ...
         fReader.onloadend = function (e) {
            ...
            console.log(totalFiles[0].file.name);
            console.log(totalFiles[0].file);
            ...
            // Serialize the form data
            	...
            	if (formdata){
                    ...
                    //xhr.open('POST', 'http://172.22.77.130:8080/AgroVision/rest/files/upload');
                    ...
                    xhr.onload = function () {
                    	...
                    	document.getElementById("plaga").innerHTML = divPlaga;
                    };
      ...
      button.mouseenter(function onMouseEnter(event) {
        button.css("background", "#white").css("color", "206D2C");
        ...
        // Add all files get from the dialog box or drag'n drop,
          ...
          if(formData){
                $.ajax({
                   ...
                   //url : 'http://172.22.77.130:8080/AgroVision/rest/files/upload',
